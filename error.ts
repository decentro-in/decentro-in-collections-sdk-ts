...
/**
 * This class provides a wrapper for network errors when making requests to decentro-in-collections
 */
export class DecentroError extends Error {
  /**
   * The response body
   */
